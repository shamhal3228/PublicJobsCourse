...
export default (props) => {
    ...
    return (
        <Box p={2} mt={-5} mb={2} className={classes.wrapper}>
            ...
            <Button onClick={search} disabled={loading} variant="contained" color="primary" disableElevation> {loading ? (<CircularProgress color="secondary" size={22} />) : ( "Search" )} </Button>
        </Box>
);
}